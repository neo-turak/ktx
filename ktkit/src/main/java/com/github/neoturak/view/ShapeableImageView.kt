...
class ShapeableImageView : AppCompatImageView {
    ...
    private fun initView(context: Context?, attrs: AttributeSet?) {
        ...
        //边框颜色
        strokeColor = ta.getColor(R.styleable.ShapeableImageView_shape_strokeColor, Color.BLUE)
        strokeWidth = ta.getDimension(R.styleable.ShapeableImageView_shape_strokeWidth, 0f)
        //背景颜色
        soldColor = ta.getColor(R.styleable.ShapeableImageView_shape_soldColor, Color.CYAN)
        ta.recycle()
        setAttrs()
    }
